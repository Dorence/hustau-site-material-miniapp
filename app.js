...
App({
  globalData: {
    rule: "1.请至少提前两天准备好活动策划。在Hust社指场地借用小程序上申请借用教室，并将策划电子版以“36号楼教室借用+协会名称+日期”的方式命名发送至办公室公邮bangongshi_hustag@163.com。审批情况可在小程序.上查询，审批通过方可使用;\n2.使用教室的当天须将手机上教室借用确认单给阿姨查看，并在二楼值班处在三十六号楼教室借用登记表上进行借用登记;\n3.建议申请前先查询教室是否空闲，查询方式: Hust社指场地借用小程序——教室借用查询;\n4.房间钥匙请找阿姨取用，教室使用结束后请将门锁好，把钥匙交给阿姨并在三十六号楼教室借用登记表上签离;\n5.普通教室须有活动负责人陪同使用并保证器材设备完好，活动结束后请将教室清理干净、桌椅归位，如发现教室卫生及器材损坏问题将影响未来二次借用，谢谢配合;\n6.如有任何疑问，请联系36号楼教室借用负责人董雨奇:13050977519。",
    status: 0
  },
  globalForm: {},
  onLaunch: function() {
